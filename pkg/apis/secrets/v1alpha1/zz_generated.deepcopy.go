...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureKeyVaultSecretEntry) DeepCopyInto(out *AzureKeyVaultSecretEntry) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureKeyVaultSecretEntry.
func (in *AzureKeyVaultSecretEntry) DeepCopy() *AzureKeyVaultSecretEntry {
	if in == nil {
		return nil
	}
	out := new(AzureKeyVaultSecretEntry)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AzureKeyVaultSecretSpec) DeepCopyInto(out *AzureKeyVaultSecretSpec) {
	*out = *in
	if in.Secrets != nil {
		...
		*out = make([]AzureKeyVaultSecretEntry, len(*in))
		copy(*out, *in)
	}
	return
}
